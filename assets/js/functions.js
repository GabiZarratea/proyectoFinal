...
const crearPlantilla = (producto) => {
  ...
  return `<div class="card" style="width: 20rem; text-align: center;" >
                      ...
                      <div class="card-body d-flex justify-content-around">
                          <button data-id="${producto._id}" class="btn btn-carrito btn-success ${articulosSeleccionados ? 'btn-danger' : ''}"></button>
                          <a href="${href}?id=${producto._id}" class="btn btn-details"> Ver más </a>
                      </div>
                  </div>`;
};
